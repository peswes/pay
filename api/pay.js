  ...
  try {
    ...
    await transporter.sendMail({
      ...
      html: `<h2>Dear ${name},</h2>
             ...
             <p><a href="${paymentLink}" style="background:#ff7f00;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:bold;">Complete Payment</a></p>
    ...
    await transporter.sendMail({
      ...
      html: `<h3>New Booking Payment Started</h3>
             <p><b>Name:</b> ${name}</p>
             <p><b>Email:</b> ${email}</p>
